---
layout: default
title: Iggy's Scan Script
---
this is iggy's scan script
...
this works on debian on ubuntu you might need to change the command line flag on mediainfo to --Output
